...
**Impact**: Users may see incorrect dropdown options when editing the Subcategory field for new transactions, and also a data validation warning on cells generated or updated by this tool.  
